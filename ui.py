...
"}")
        ...
        self.label_3.setGeometry(QtCore.QRect(80, 130, 180, 21))
        ...
        self.menuLaunguage = QtWidgets.QMenu(self.menuOptions)
        self.menuLaunguage.setObjectName("menuLaunguage")
        ...
        self.actionDon_t_save = QtWidgets.QAction(MainWindow)
        self.actionDon_t_save.setObjectName("actionDon_t_save")
        ...
        self.menuNew.addAction(self.actionDon_t_save)
        self.menuNew.addAction(self.actionSave_2)
        self.menuFIle.addAction(self.menuNew.menuAction())
        self.menuFIle.addAction(self.actionOpen)
        self.menuFIle.addAction(self.actionSaveAs)
        self.menuFIle.addAction(self.actionSave)
        self.menuLaunguage.addAction(self.actionEnglish)
        self.menuLaunguage.addAction(self.actionSpanish)
        self.menuLaunguage.addAction(self.actionUkrainian)
        self.menuLaunguage.addAction(self.actionFrench)
        self.menuOptions.addAction(self.menuLaunguage.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuLaunguage.setTitle(_translate("MainWindow", "Launguage"))
        self.actionOpen.setText(_translate("MainWindow", "Open"))
        self.actionSaveAs.setText(_translate("MainWindow", "Save As"))
        self.actionDon_t_save.setText(_translate("MainWindow", "Don`t save"))
